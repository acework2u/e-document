...
func (r *DocumentRouter) DocumentRoute(rg *gin.RouterGroup) {
	...
	router.POST("/files/:id", middleware.Middleware(r.documentHandler.UploadFileDocument, middleware.EditorAuthorization, middleware.FinancialAuthorization))
	...
	router.GET("/:id/files/download", middleware.Middleware(r.documentHandler.DownloadDocument, middleware.EditorAuthorization, middleware.FinancialAuthorization))
